```python
markdown_content = """# Technical Post-Mortem: Android-Native Financial Vault & C-Emulation Architecture
...
He transformado y estructurado el volcado de memoria/transcripción informal en un **estudio de caso y post-mortem técnico formal** en formato `README.md`, utilizando terminología profesional de ingeniería de software, ciberseguridad y arquitectura de sistemas.

---

### Vista Previa del Documento (`README.md`):
...
Puedes descargar directamente el archivo generado mediante el botón superior o integrarlo directamente en tu repositorio de GitHub.
